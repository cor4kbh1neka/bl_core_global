...
class GetDataApkUseCase {
    ...
    async execute(params) {
        try {
            ...
            const result = await this._cacheService.get(`ciaapkid:${params.apkid}`);
            ...
            await this._cacheService.delete(`ciaapkid:${params.apkid}`);
            await this._cacheService.set(`ciaapkid:${params.apkid}`, JSON.stringify(dataapkfull));
