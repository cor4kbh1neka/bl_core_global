...
class ContentUseCase {
    ...
    async editmttag(useCasePayload, params) {
        ...
        await this._cacheService.delete(`ciametatag:metatag`);
    ...
    async getmttag() {
        try {
            const result = await this._cacheService.get(`ciametatag:metatag`);
            ...
            await this._cacheService.delete(`ciametatag:metatag`);
            await this._cacheService.set(`ciametatag:metatag`, JSON.stringify(dtmttag));
            return dtmttag;
    ...
    async addstmp(useCasePayload) {
        ...
        await this._cacheService.delete(`ciasitemap:sitemap`);
    ...
    async getstmp() {
        try {
            const result = await this._cacheService.get(`ciasitemap:sitemap`);
            const dataresult = JSON.parse(result);
            dataresult.headers = {
                'X-Data-Source': 'cache',
            };
            ...
            await this._cacheService.delete(`ciasitemap:sitemap`);
            await this._cacheService.set(`ciasitemap:sitemap`, JSON.stringify(dtstmp));
            return dtstmp;
    ...
    async editgeneral(useCasePayload, params) {
        ...
        await this._cacheService.delete(`ciactgeneral:ctgeneral`);
        return 'general data updated';
    }
    async getgeneral() {
        try {
            const result = await this._cacheService.get(`ciactgeneral:ctgeneral`);
            const dataresult = JSON.parse(result);
            dataresult.headers = {
                'X-Data-Source': 'cache',
            };
            ...
            await this._cacheService.delete(`ciactgeneral:ctgeneral`);
            await this._cacheService.set(`ciactgeneral:ctgeneral`, JSON.stringify(dtgeneral));
            return dtgeneral;
        }
    }
    ...
    async editslider(useCasePayload, params) {
        ...
        await this._cacheService.delete(`ciactslider:ctslider`);
    ...
    async getslider() {
        try {
            ...
            const result = await this._cacheService.get(`ciactslider:ctslider`);
            const dataresult = JSON.parse(result);
            dataresult.headers = {
                'X-Data-Source': 'cache',
            };
            ...
            await this._cacheService.delete(`ciactslider:ctslider`);
            await this._cacheService.set(`ciactslider:ctslider`, JSON.stringify(dtslider));
            return dtslider;
        }
    }
    ...
    async editlink(useCasePayload, params) {
        ...
        await this._cacheService.delete(`ciactlink:ctlink`);
        return 'link data updated';
    }

    async getlink() {
        try {
            const result = await this._cacheService.get(`ciactlink:ctlink`);
            const dataresult = JSON.parse(result);
            dataresult.headers = {
                'X-Data-Source': 'cache',
            };
            ...
            await this._cacheService.delete(`ciactlink:ctlink`);
            await this._cacheService.set(`ciactlink:ctlink`, JSON.stringify(dtlink));
            return dtlink;
        }
    }
    ...
    async editsocmed(useCasePayload, params) {
        ...
        await this._cacheService.delete(`ciactsocmed:ctsocmed`);
        return 'social media data updated';
    }

    async getsocmed() {
        try {
            const result = await this._cacheService.get(`ciactsocmed:ctsocmed`);
            const dataresult = JSON.parse(result);
            dataresult.headers = {
                'X-Data-Source': 'cache',
            };
            ...
            await this._cacheService.delete(`ciactsocmed:ctsocmed`);
            await this._cacheService.set(`ciactsocmed:ctsocmed`, JSON.stringify(dtsocmed));
            return dtsocmed;
        }
    }
    ...
    async addpromo(useCasePayload) {
        ...
        await this._cacheService.delete(`ciactpromo:ctpromo`);
    ...
    async getpromo() {
        try {
            const result = await this._cacheService.get(`ciactpromo:ctpromo`);
            const dataresult = JSON.parse(result);
            dataresult.headers = {
                'X-Data-Source': 'cache',
            };
            ...
            await this._cacheService.delete(`ciactpromo:ctpromo`);
            await this._cacheService.set(`ciactpromo:ctpromo`, JSON.stringify(dtpromo));
            return dtpromo;
        }
    }
    ...
    async editmt(useCasePayload, params) {
        ...
        await this._cacheService.delete(`ciactmaintenance:ctmaintenance`);
        return 'Status updated';
    }

    async getmt() {
        try {
            const result = await this._cacheService.get(`ciactmaintenance:ctmaintenance`);
            const dataresult = JSON.parse(result);
            dataresult.headers = {
                'X-Data-Source': 'cache',
            };
            ...
            await this._cacheService.delete(`ciactmaintenance:ctmaintenance`);
            await this._cacheService.set(`ciactmaintenance:ctmaintenance`, JSON.stringify(dtmt));
            return dtmt;
        }
    }
