...
describe('APK DATA RESERVER API POST GET DATA', () => {
    it('should get data apk caching successfully', async () => {
        ...
        expect(mockcacheService.get).toBeCalledWith(`ciaapkid:${params.apkid}`);
    ...
    it('should get data apk successfully', async () => {
        ...
        expect(mockcacheService.delete).toBeCalledWith(`ciaapkid:${params.apkid}`);
        expect(mockcacheService.set).toBeCalledWith(`ciaapkid:${params.apkid}`, JSON.stringify(resultmocksettings));
        expect(dataapkusecase).toEqual({
            data: resultmocksettings
        });
    });
