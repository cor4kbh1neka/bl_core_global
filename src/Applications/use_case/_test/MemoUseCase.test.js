...
describe('MEMO', () => {
    ...
    describe('AddMemo data', () => {
        it('should orchestrating add memo correctly', async () => {
            ...
            expect(mockcacheService.delete).toBeCalledWith(`daunmemo:memo`);
        });
    });
    describe('getdatamemo VIP that already create', () => {
        it("should get data memo caching", async () => {
            ...
            expect(mockcacheService.get).toBeCalledWith(`daunmemo:memo`);
        ...
        it('should get data memo bank', async () => {
            ...
            expect(mockcacheService.delete).toBeCalledWith(`daunmemo:memo`);
            expect(mockcacheService.set).toBeCalledWith(`daunmemo:memo`, JSON.stringify(resultmemo));
        });
    });
    ...
    describe('getdatamemo that already create', () => {
        it("should get data memo caching", async () => {
            ...
            expect(mockcacheService.get).toBeCalledWith(`daunmemoll:${params.statustype}`);
            expect(payload).toEqual(
                resultmemo
            );
        });
        it('should get data memo bank', async () => {
            ...
            expect(payload).toEqual(resultmemo);
            expect(mockcacheService.delete).toBeCalledWith(`daunmemoll:${params.statustype}`);
            expect(mockcacheService.set).toBeCalledWith(`daunmemoll:${params.statustype}`, JSON.stringify(resultmemo));
        });
    });
