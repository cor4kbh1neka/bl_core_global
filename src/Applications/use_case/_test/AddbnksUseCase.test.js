...
describe('GROUPBANK', () => {
    ...
    describe('AddGroup bnks api for add master data', () => {
        it('should orchestrating add group correctly', async () => {
            ...
            expect(mockcacheService.delete).toBeCalledWith(`ciagroup:group`);
    ...
    describe('GetDataGroup that already create', () => {
        it("should get data group bank caching", async () => {
            ...
            expect(mockcacheService.get).toBeCalledWith(`ciagroup:group`);
        ...
        it('should get data group bank', async () => {
            ...
            expect(mockcacheService.delete).toBeCalledWith(`ciagroup:group`);
            expect(mockcacheService.set).toBeCalledWith(`ciagroup:group`, JSON.stringify(resultmockgroup));
        });
    });
...
describe('MASTER BANK', () => {
    ...
    describe('Add Master bnks for add master data', () => {
        ...
        it('should orchestrating add master correctly', async () => {
            ...
            expect(mockcacheService.delete).toBeCalledWith(`cianamemaster:master`);
        });
    });
    ...
    describe('GetdataMaster that already create', () => {
        it("should get data master bank caching", async () => {
            ...
            expect(mockcacheService.get).toBeCalledWith(`cianamemaster:master`);
            expect(payload).toEqual(
                resultmockmaster
            );
        });
        it('should get data master bank', async () => {
            ...
            expect(mockBnksRepository.getmstrbnk)
                .toBeCalledWith();
            expect(mockcacheService.delete).toBeCalledWith(`cianamemaster:master`);
            expect(mockcacheService.set).toBeCalledWith(`cianamemaster:master`, JSON.stringify(resultmockmaster));
...
describe('DATA BANK', () => {
    describe('add data BANK', () => {
        it('should orchestrating add data apk get correctly', async () => {
            ...
            expect(mockcacheService.delete).toBeCalledWith(`cianamegroup:${resultmockdoneadd.namegroupxyzt[0]}`);
        });
    });
    describe('edit data BANK', () => {
        ...
        it('should edit data groupbank correctly', async () => {
            ...
            expect(mockcacheService.delete).toBeCalledWith(`cianamegroup:${useCasePayload.namegroupxyzt}`);
        ...
        it('should edit data bank data correctly', async () => {
            ...
            checkbank.namegroupxyzt.forEach(async (group) => {
                expect(mockcacheService.delete).toBeCalledWith(`cianamegroup:${group}`);
            });
    ...
    describe('BANK DATA GET DATA', () => {
        it('should get data apk caching successfully', async () => {
            ...
            expect(mockcacheService.get).toBeCalledWith(`cianamegroup:${params.groupname}`);
        ...
        it('should get data bank successfully', async () => {
            ...
            expect(mockcacheService.delete).toBeCalledWith(`cianamegroup:${params.groupname}`);
            expect(mockcacheService.set).toBeCalledWith(`cianamegroup:${params.groupname}`, JSON.stringify(getdatausecase));
    ...
    describe('BANK DATA GET DATA EXCEPT GROUP', () => {
        ...
        //     expect(mockcacheService.get).toBeCalledWith(`cianamegroupex:${params.groupname}`);
        //     expect(getdatausecase).toEqual(
        //         resultmockgroup
        ...
        it('should get data bank except successfully', async () => {
            ...
            // expect(mockcacheService.delete).toBeCalledWith(`cianamegroupex:${params.groupname}`);
            // expect(mockcacheService.set).toBeCalledWith(`cianamegroupex:${params.groupname}`, JSON.stringify(getdatausecase));
            expect(getdatausecase).toEqual(resultmockgroup);
        });
    });
    ...
    describe("delete  group bank for master data", () => {
        it("should delete data group succesfully", async () => {
            ...
            expect(datasuccess).toEqual(resultdelete);
            expect(mockcacheService.delete).toBeCalledWith(`cianamegroup:${bank1}`);
            expect(mockcacheService.delete).toBeCalledWith(`cianamegroup:${bank2}`);
    ...
    describe("delete  group bank array for master data", () => {
        it("should delete data group succesfully", async () => {
            ...
            expect(mockBnksRepository.delbankar)
                .toBeCalledWith(params);
            expect(datasuccess).toEqual(resultdelete);
            expect(mockcacheService.delete).toBeCalledWith(`cianamegroup:${params.groupbank}`);
